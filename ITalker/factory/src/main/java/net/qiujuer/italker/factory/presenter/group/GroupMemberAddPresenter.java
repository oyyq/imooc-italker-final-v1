...
public class GroupMemberAddPresenter
        extends BaseRecyclerPresenter<GroupCreateContract.ViewModel,
    ...
    public void submit() {
        ...
        // 进行网络请求
        GroupMemberModel model = new GroupMemberModel(users);
    ...
    private Runnable loader = new Runnable() {
        ...
        public void run() {
            ...
            refreshData(models);                //刷新到GroupMemberAddFragment.recyclerview
        }
    };
    ...
    public void onDataLoaded(List<GroupMemberCard> groupMemberCards) {
        ...
        Run.onUiAsync(new Action() {
            ...
            public void call() {
                ...
                if (view == null)
                    return;
                view.onAddedSucceed();    //直接停掉GroupMemberAddFragment, 新增数据在GroupMemberActivity.recyclerView进行刷新
            }
        });
    }
    ...
    /**
     * 群员添加失败的回调, 直接到GroupMemberActivity去显示错误信息
     * @param strRes
     */
    @Override
