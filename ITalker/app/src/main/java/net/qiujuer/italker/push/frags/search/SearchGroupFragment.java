 ...
 * 搜索群的界面实现
 */
public class SearchGroupFragment
        extends PresenterFragment<SearchContract.Presenter>
        implements SearchActivity.SearchFragment,
        SearchContract.GroupView, ApplyCallback
    {
    ...
    class ViewHolder extends RecyclerAdapter.ViewHolder<GroupCard> {
        ...
        void onJoinClick() {
           ...
           //发起入群申请
            GroupHelper.JoinGroup(mData.getId(),
                    Account.getUserId(), (ApplyCallback)this);
        }
    }
}
