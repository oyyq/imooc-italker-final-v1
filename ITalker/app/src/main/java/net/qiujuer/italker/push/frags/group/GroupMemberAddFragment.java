 ...
 * 群成员添加的Fragment
 */
public class GroupMemberAddFragment
        extends BottomSheetDialogFragment
        implements GroupMemberAddContract.View {


   // private int height = (int) (getResources().getDisplayMetrics().heightPixels * 0.6);
    ...
    private GroupMembersContract.Presenter presenter;        //备用回调, 实例是GroupMembersPresenter
    ...
    public void onAttach(Context context) {
        ...
        // context 就是咱们的GroupMemberActivity
    ...
    public void onAddedSucceed() {
        ...
        dismiss();          //DialogFragment的方法, 相当于销毁Fragment
    }
