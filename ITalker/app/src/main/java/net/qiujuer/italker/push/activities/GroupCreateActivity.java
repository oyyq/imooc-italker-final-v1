...
public class GroupCreateActivity
        extends PresenterToolbarActivity<GroupCreateContract.Presenter>
    ...
    void onPortraitClick() {
        ...
        new GalleryFragment( (int) (getResources().getDisplayMetrics().heightPixels * 0.6) )
    ...
    // 隐藏软件盘, todo 11-05 21:30 点击其他控件隐藏软键盘可以借鉴
